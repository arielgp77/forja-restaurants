...
import { buildPublicHomeViewModel } from "../../../../lib/public-home/view-model";

export default async function PublicHomePreviewPage({
  params,
}: {
  params: Promise<{ slug: string }>;
}) {
  const { slug } = await params;
  const vm = await buildPublicHomeViewModel(slug);
